    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 no-scrollbar">
      ...
      <div className="relative pt-2">
        <div className="mx-0 relative z-10">
          <div className="bg-white p-6 sm:p-10 rounded-[32px] shadow-2xl shadow-slate-200/50 border border-slate-100 ring-1 ring-blue-400/10 flex flex-col md:flex-row items-center md:items-center gap-6 sm:gap-12 group transition-all duration-500">
            <div className="relative group/photo shrink-0">
                <div className="h-24 w-24 xs:h-32 xs:w-32 sm:h-40 sm:w-40 rounded-[32px] border-[6px] border-slate-50 shadow-xl overflow-hidden bg-slate-100 flex items-center justify-center text-slate-300 font-bold text-3xl sm:text-5xl font-poppins transition-transform duration-500 group-hover:scale-105">
                ...
                <div className="absolute -bottom-1 -right-1 bg-emerald-500 border-4 border-white h-9 w-9 rounded-full shadow-lg ring-4 ring-emerald-500/20"></div>
            </div>
            
            <div className="flex-1 text-center md:text-left space-y-2">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 justify-center md:justify-start">
                  <h1 className="text-3xl xs:text-4xl sm:text-5xl font-black text-slate-900 tracking-tight font-poppins capitalize">{stats.student_name}</h1>
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 sm:gap-8 pt-2">
                <div className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-slate-50 border border-slate-100 font-inter">
                    <span className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Student ID:</span>
                    <span className="text-sm font-black text-indigo-600">{stats.student_id}</span>
                </div>
                ...
                <div className="flex items-center gap-3 group/stat cursor-help">
                    ...
                    <div>
                        <p className="text-[11px] font-black text-slate-500 uppercase tracking-[0.1em] leading-none font-inter">Total Enrollments</p>
                        <p className="text-sm font-black text-slate-900 mt-1 font-poppins">{stats.subjects_count} Active Modules</p>
                    </div>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
        <div className="card-standard p-6 sm:p-8 bg-white group hover:border-blue-200 transition-all duration-500 relative overflow-hidden shadow-xl shadow-slate-200/50 border border-slate-100 ring-1 ring-blue-400/10">
          <p className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 font-inter">Total Subjects Fee</p>
          <div className="flex items-end gap-2">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight font-poppins">{formatCurrency(totalFee)}</h2>
            <span className="text-[10px] sm:text-[11px] font-black text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full mb-1 font-inter">Locked</span>
          </div>
        ...
        <div className="card-standard p-6 sm:p-8 bg-white group hover:border-emerald-200 transition-all duration-500 relative overflow-hidden shadow-xl shadow-slate-200/50 border border-slate-100 ring-1 ring-blue-400/10">
          <p className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 font-inter">Total Fees Paid</p>
          <div className="flex items-end gap-3">
            <h2 className="text-3xl sm:text-4xl font-black text-emerald-600 tracking-tight font-poppins">{formatCurrency(totalPaid)}</h2>
            <span className="text-xs sm:text-sm font-black text-emerald-500/80 mb-1.5 font-inter bg-emerald-50 px-3 py-1 rounded-lg">{paidPercentage.toFixed(1)}% Clear</span>
          </div>
        ...
        <div className="card-standard p-6 sm:p-8 bg-white group hover:border-rose-200 transition-all duration-500 relative overflow-hidden shadow-xl shadow-slate-200/50 border border-slate-100 ring-1 ring-blue-400/10">
          <p className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 font-inter">Pending Dues</p>
          <div className="flex items-end gap-2">
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight font-poppins text-rose-600 uppercase">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Enrolled Subjects List Section */}
        <div className="lg:col-span-2 card-standard p-6 sm:p-10 bg-white shadow-lg shadow-slate-200/40 ring-1 ring-blue-400/10 border border-slate-100">
        ...
        <div className="card-standard p-6 sm:p-10 bg-white flex flex-col group/fin shadow-lg shadow-slate-200/40 ring-1 ring-blue-400/10 border border-slate-100">
