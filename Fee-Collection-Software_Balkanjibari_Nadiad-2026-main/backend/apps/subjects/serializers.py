...
class SubjectBatchSerializer(serializers.ModelSerializer):
    ...
    def get_enrolled_count(self, obj):
        ...
        return getattr(obj, 'enrolled_count_annotated', obj.enrolled_count)
    
    def get_available_seats(self, obj):
        """Get available seats in this batch."""
        enrolled = getattr(obj, 'enrolled_count_annotated', obj.enrolled_count)
        return max(0, obj.capacity_limit - enrolled)
    
    def get_is_full(self, obj):
        """Check if batch is full."""
        enrolled = getattr(obj, 'enrolled_count_annotated', obj.enrolled_count)
        return enrolled >= obj.capacity_limit
