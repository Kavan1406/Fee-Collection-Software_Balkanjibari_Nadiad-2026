    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="relative">
        ...
        <div className="px-4 sm:px-10 -mt-20 sm:-mt-24 relative z-10 flex flex-col items-center">
          <div className="bg-white dark:bg-slate-900 w-full max-w-2xl p-6 sm:p-10 rounded-[32px] sm:rounded-[48px] shadow-2xl shadow-slate-200/50 border border-slate-50 dark:border-slate-800 relative group overflow-hidden transition-all duration-500">
            
            <div className="flex flex-col items-center relative z-10 text-center">
              {/* Overlapping Square Avatar */}
              <div className="relative -mt-20 sm:-mt-24 mb-6">
                <div className="h-28 w-28 sm:h-36 sm:w-36 rounded-[28px] sm:rounded-[36px] border-[6px] sm:border-[8px] border-white dark:border-slate-800 shadow-2xl overflow-hidden bg-slate-50 flex items-center justify-center text-slate-300 font-bold text-3xl sm:text-5xl font-poppins transition-transform duration-500 group-hover:scale-105">
                ...
                {/* Status Dot */}
                <div className={`absolute bottom-1 right-1 h-8 w-8 rounded-full border-4 border-white dark:border-slate-800 shadow-lg ${
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                    <h1 className="text-2xl sm:text-4xl font-bold text-slate-900 dark:text-white tracking-tight font-poppins uppercase">{student.name}</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 px-2">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-[28px] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/20 relative overflow-hidden group">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white relative z-10 tracking-tight font-poppins">{formatCurrency(totalFee)}</h2>
          <div className="w-10 h-10 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 absolute right-6 bottom-6 shadow-sm group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500">
            <BookOpen size={18} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-[28px] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/20 relative overflow-hidden group">
          ...
          <div className="w-10 h-10 rounded-2xl bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center text-emerald-600 absolute right-6 bottom-6 shadow-sm group-hover:bg-emerald-600 group-hover:text-white transition-all duration-500">
            <CreditCard size={18} />
          </div>
        </div>
 
        <div className="bg-white dark:bg-slate-900 p-6 rounded-[28px] border border-rose-100 dark:border-rose-900/30 shadow-xl shadow-rose-200/20 relative overflow-hidden group col-span-2 lg:col-span-1">
          <div className="absolute right-[-20px] top-[-20px] opacity-[0.03] group-hover:opacity-[0.08] transition-opacity">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-2">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-6 sm:p-10 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/20">
          <div className="flex items-center justify-between mb-8 sm:mb-12">
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white tracking-tight uppercase font-poppins">Academic Portfolio</h2>
          ...
          <div className="space-y-4">
            {filteredEnrollments.length === 0 ? (
              <div className="text-center py-20 bg-slate-50/50 dark:bg-slate-800/30 rounded-[32px] border-2 border-dashed border-slate-200 dark:border-slate-700 transition-all font-inter">
                <BookOpen className="mx-auto text-slate-300 dark:text-slate-600 mb-4 opacity-50" size={56} />
              ...
              filteredEnrollments.map((enr: any, idx: number) => (
                <div key={idx} className="group p-5 bg-slate-50/30 dark:bg-slate-800/20 hover:bg-white dark:hover:bg-slate-800 border border-slate-100/50 dark:border-slate-700/50 hover:border-indigo-100 dark:hover:border-indigo-900/50 rounded-[28px] transition-all duration-500 hover:shadow-xl hover:shadow-indigo-500/5">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                      <div className="flex items-center gap-5">
                        <div className="w-14 h-14 bg-white dark:bg-slate-700 rounded-2xl border border-slate-100 dark:border-slate-600 shadow-sm flex items-center justify-center text-indigo-600 font-bold text-xs shrink-0 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500">
                        ...
                        <div className="min-w-0">
                          <div className="flex flex-col">
                              ...
                              <h3 className="font-bold text-slate-800 dark:text-white text-lg tracking-tight uppercase truncate font-poppins">{enr.subject_name}</h3>
                          </div>
                        </div>
                      </div>
                      
                      <div className="flex flex-wrap items-center gap-3 sm:gap-6">
                        <div className="bg-white dark:bg-slate-800 px-4 py-2 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm font-inter">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="h-11 w-11 sm:h-12 sm:w-auto sm:px-6 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-600 hover:text-white transition-all text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 border border-indigo-100/50 font-poppins"
                            title="Receipt"
                          >
                            <Receipt size={18} />
                          ...
                          <button
                            ...
                            className="h-11 w-11 sm:h-12 sm:w-auto sm:px-6 rounded-2xl bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-600 hover:text-white transition-all text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 border border-emerald-100/50 font-poppins"
                            title="ID Card"
                          >
                            <IdCard size={18} />
        ...
        <div className="bg-white dark:bg-slate-900 p-6 sm:p-10 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/20 flex flex-col">
          <div className="flex items-center gap-3 mb-10 border-b border-slate-50 dark:border-slate-800 pb-6">
            ...
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white tracking-tight uppercase font-poppins">Collection</h2>
                <p className="text-[10px] font-bold text-slate-900 uppercase tracking-[0.2em] mt-0.5 font-inter">Financial Progress</p>
            </div>
          </div>
          
          <div className="space-y-10 flex-1">
            <div className="p-6 rounded-[28px] bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 shadow-inner">
              <div className="flex justify-between items-end mb-4">
                ...
                <div className="w-10 h-10 rounded-full bg-white dark:bg-slate-700 flex items-center justify-center shadow-sm border border-slate-50 dark:border-slate-600">
                    <TrendingUp size={16} className="text-emerald-500" />
                </div>
              </div>
              <div className="h-3 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden p-0.5 shadow-inner">
                <div 
              ...
              <div className="mt-6 flex justify-between">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs font-bold text-slate-900 dark:text-white font-poppins">{formatCurrency(totalFee)}</p>
                  </div>
              </div>
            </div>
 
            <div className="space-y-4">
              <div className="flex justify-between items-center text-sm p-4 rounded-2xl border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                ...
                <span className="font-bold text-slate-900 dark:text-white tracking-tight font-poppins">{formatCurrency(totalFee)}</span>
              </div>
              
              <div className="flex justify-between items-center text-sm p-4 rounded-2xl bg-emerald-50/50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/30">
              ...
              <div className="flex justify-between items-center p-5 rounded-2xl bg-rose-50/50 dark:bg-rose-900/10 border border-rose-100 dark:border-rose-900/30 mt-6 shadow-sm">
            ...
            <div className="p-5 rounded-2xl bg-indigo-50/30 dark:bg-indigo-900/10 border border-indigo-100/30 dark:border-indigo-900/30 flex items-start gap-4">
